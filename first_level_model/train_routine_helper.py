...
def loss_fn(start_logits, end_logits,
    ...
    """
    Kullback-Leibler divergence(KLDivLoss) is a useful distance measure for 
    continuous distributions and is often useful when performing 
    direct regression over the space of (discretely sampled) continuous
    ...
    with torch.no_grad():
        ...
        for _, d in enumerate(tk0):
            ...
            for px, tweet in enumerate(orig_tweet):
                ...
                jaccard_score, _ = \
                    helper.calculate_jaccard(original_tweet=tweet,
